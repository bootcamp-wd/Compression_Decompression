...
// Log levels enumeration for various severity levels
enum { LOG_TRACE, LOG_DEBUG, LOG_INFO, LOG_WARN, LOG_ERROR, LOG_FATAL };

// Macros for logging at different levels, including file name and line number
...
// Core logging function called by the macros. Not intended for direct use.
